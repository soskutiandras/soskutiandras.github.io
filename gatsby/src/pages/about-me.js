        ...
        <Layout theme="white" openContactPopup={this.openContactPopup}>
          <AboveFold>
            ...
            <t.LargeP align="center" max70>
              Experienced in software development, logistics and customer service
            </t.LargeP>
          </AboveFold>
          <Content>
            <Img fluid={data.avatarAbout.childImageSharp.fluid} alt="Soskuti Andras" className="avatar" />
            {/* <t.LargeP>
